...
export default function ProductCard({
    id, name, price, originalPrice, image, category, subcategory, rating, discount, isGrocery, brand, description
}: ProductCardProps & { description?: string }) {
    ...
    return (
        <>
            ...
            {showQuickView && (
                <QuickViewModal
                    product={{ id, name, price, originalPrice, image, category, subcategory, rating, discount, isGrocery, brand, description }}
